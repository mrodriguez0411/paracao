...
-- 2) Create tables and policies (from 001_create_tables.sql)
...
-- Crear tabla de miembros de familia (moved up so policies that reference it work)
...
-- (miembros_familia definition moved earlier)
...
-- 3) Trigger function and trigger (from 002_create_profile_trigger.sql)
...
-- Asegurar que no exista el trigger antes de crear
