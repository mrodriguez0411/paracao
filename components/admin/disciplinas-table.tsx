          ...
          {disciplinas.map((disciplina) => (
            <TableRow key={disciplina.id} className="hover:bg-gray-50/50 transition-colors border-b border-gray-50 last:border-0">
              ...
              <TableCell className="text-right pr-6">
                <Button variant="ghost" size="sm" asChild className="text-gray-500 hover:bg-green-50 hover:text-green-700 rounded-lg p-2 h-9 w-9">
                    <Link href={`/admin/disciplinas/${disciplina.id}/actividades`}>
