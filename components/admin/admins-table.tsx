            ...
            <Table>
                <TableHeader className="bg-white border-b border-gray-100">
                    <TableRow className="hover:bg-transparent">
                        ...
                        <TableHead className="text-gray-500 font-medium text-[11px] tracking-wider uppercase py-4 text-right pr-6">Acciones</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
                    {admins.map((admin) => (
                        <TableRow key={admin.id} className="hover:bg-gray-50/50 transition-colors border-b border-gray-50 last:border-0">
                            ...
                            <TableCell className="text-right pr-6">
                                <Button asChild variant="outline" size="sm" style={{ color: '#efb600' }}>
                                    <Link href={`/admin/admins/${admin.id}/editar`}>
